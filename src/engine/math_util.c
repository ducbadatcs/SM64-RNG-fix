...
static u16 gRandomSeed16 = 1;

// Generate a pseudorandom integer from 0 to 65535 from the random seed, and update the seed.
u16 random_u16(void) {
    // use the xorshift algorithm for a 32-bit int, then take the last 16 digits
    gRandomSeed16 ^= (gRandomSeed16 << 7);
    gRandomSeed16 ^= (gRandomSeed16 >> 9);
    gRandomSeed16 ^= (gRandomSeed16 << 8);
